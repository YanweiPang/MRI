...
elif [ "${model_type}" == "ds-transformer" ]; then
  model_type=simple_transformer
elif [ "${model_type}" == "ss-transformer" ]; then
  model_type=ss_transformer
elif [ "${model_type}" == "ss_maskfusedtransformer" ]; then
  model_type=ss_maskfusedtransformer
elif [ "${model_type}" == "ss_CrossViT" ]; then
  model_type=ss_CrossViT
