...
import Phase_selection.activemri.baselines as mri_baselines
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dqn_model_type",
        type=str,
        choices=["simple_mlp", "evaluator", "ss_maskfusedtransformer"],
        default="evaluator",
    )
    parser.add_argument(
        "--reward_metric",
    ...
    parser.add_argument("--num_test_episodes", type=int, default=200)
    parser.add_argument("--dqn_only_test", action="store_true")
    parser.add_argument("--dqn_weights_path", type=str, default=None)
    parser.add_argument("--dqn_test_episode_freq", type=int, default=3000)
    ...
    parser.add_argument("--ignore_mask", action="store_true", default=False)
