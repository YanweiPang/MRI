...
random_file = "../results4ssimcurve/curvedata/run-random-70l_lightning_logs_version_0-tag-val_metrics_ssim.json"
zhang_file = "../results4ssimcurve/curvedata/run-evaluator_4gpu_test_lightning_logs_version_0-tag-val_metrics_ssim.json"
pineda_file = "../results4ssimcurve/curvedata/run-ss-ddqn-recon-org-70l_lightning_logs_version_0-tag-val_metrics_ssim.json"
title_file = "../results4ssimcurve/curvedata/run-recon_free_with_test_reward100_ss_trt_maskfused-70l_lightning_logs_version_0-tag-val_metrics_ssim.json"

save_dir = "../plots/ssim_curve"
...
plt.xlabel("Epoch")
plt.ylabel("SSIM")
plt.savefig(save_dir + "/ssim_curve.tiff", bbox_inches="tight")
