...
import Phase_selection.activemri.experimental.cvpr19_models.models.reconstruction as cvpr19_reconstruction
import Phase_selection.activemri.models


# This is just a wrapper for the model in cvpr19_models folder
class CVPR19Reconstructor(Phase_selection.activemri.models.Reconstructor):
    def __init__(
        self,
    ...
    def forward(  # type: ignore
        ...
        print("L48 cvpr19_reconstructor.py:", type(zero_filled_input), zero_filled_input.size())
        reconstructed_image, uncertainty_map, mask_embedding = self.reconstructor(
            zero_filled_input, mask
        )
        print("L51 cvpr19_reconstructor.py:", type(reconstructed_image), reconstructed_image.size())
